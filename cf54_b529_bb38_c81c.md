...
![](HR_space02-1.jpg)
![](HR_space03-01.jpg)
**[코딩 문제 05] 소수(Prime Number) 구하기 앱 제작**

아래의 Playgroung 소스 코드를 이용하여 소수(Prime Number)를 구하는 앱을 제작하시오.
* *코딩 조건 1)*
Again Button을 터치하면 TextField와 Result Label의 값이 초기화(clear) 되고, 카패드가 사라진다.
* *코딩 조건 2)*
TextField를 `ClearButtonMode`를 `Always`로 설정하고 작동되도록 하시오.
* *코딩 조건 3)*
